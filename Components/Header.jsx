  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'> 
        ...
        <div className='text-center my-8'>
            ...
            <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa minima, ratione sint at harum nobis voluptatibus aspernatur expedita totam mollitia nam voluptas odio saepe dolorum excepturi aut hic vero impedit.</p>
